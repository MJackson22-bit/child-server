...
export class PurchaseRouter extends BaseRouter<PurchaseController> {
    ...
    routes(): void {
        ...
        this.router.get('user/updatePurchase/:id', (req, res) => this.controller.updatePurchase(req, res));
        this.router.get('user/deletePurchase/:id', (req, res) => this.controller.deletePurchase(req, res));
    }
}
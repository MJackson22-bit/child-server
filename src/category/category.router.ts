...
export class CategoryRouter extends BaseRouter<CategoryController> {
    ...
    routes(): void {
        ...
        this.router.put('/updateCategory', (req, res) => this.controller.updateCategory(req, res))
        this.router.delete('deleteCategory', (req, res) => this.controller.deleteCategory(req, res))
    }
}